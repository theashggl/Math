...
Future<void> streamNums(num param1, Duration param2,
    num Function(num, num) method) async {
  num temp;
...
test('paramInitializer method test', () {
when(()=>      mockObject.enumvar      ).thenReturn(EnumVar.value);
when(()=>      mockObject.streamsProcessorList[0]      ).thenReturn(2);
when(()=>      mockObject.streamsProcessorList[1]      ).thenReturn(2);
mockObject.paramInitializer();
verifyNever(() => mockObject.streamNums(
99, Duration.zero, (op1, op2) => op1 += op2));
expect(mockObject.answer, 80);
});